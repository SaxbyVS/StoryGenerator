...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        createStoryButton.addActionListener(e -> {
            ...
            // Creating Story
            storyController.createStory(setup.title, setup.strat);
        ...
        //REFRESH SCREEN - update library list (in case loaded library exists)
        refresh();
